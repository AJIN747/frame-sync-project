...
namespace PBBattle
{
  ...
  public partial class UdpBattleReady : global::ProtoBuf.IExtensible
  {
    ...
    public int battleID
    {
      ...
      set { _battleID = value; }
        ...
        private bool _isRecon;
        [global::ProtoBuf.ProtoMember(3, IsRequired = true, Name = @"isRecon", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
        public bool isRecon
        {
            get { return _isRecon; }
            set { _isRecon = value; }
  ...
  public partial class UdpDownDeltaFrames : global::ProtoBuf.IExtensible
  {
    ...
    private   global::System.Collections.Generic.List<PBBattle.UdpDownFrameOperations> _framesData = new global::System.Collections.Generic.List<PBBattle.UdpDownFrameOperations>();
