...
public class UIData : MonoBehaviour {
	...
	private void UpdateNetInfo(){
		...
		frameText.text ="frame:" + _frameNum.ToString();

		sendText.text = "发送帧:" + GetNumberString(BattleData.Instance.sendNum);
		recvText.text = "接收帧:" + GetNumberString(BattleData.Instance.recvNum);


		fpsText.text = " " + BattleData.Instance.log ;
