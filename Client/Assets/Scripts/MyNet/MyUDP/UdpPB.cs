...
public class UdpPB {
	...
	//	Debug.LogError("SendBattleReady   _upd== " + _upd);
	...
	public void SendOperation(){
		...
		BattleData.Instance.AddClientFrameData(mesNum, _up);
		//	Debug.LogError("SendOperation ***  "  );
 ...
 //       Debug.LogError("SendDeltaFrames  ");
	...
	//}
	public void SendRequestFrames(int _battleID, List<int> _frames)
	{
	...
	public void AnalyzeMessage(SCID messageId,byte[] bodyData){
		...
		case SCID.UDP_DOWN_DELTA_FRAMES:
			{
                    Debug.LogError("UDP_DOWN_DELTA_FRAMES");
